...
{
    public partial class NurdagiMulkiyet
    {
        ...
        public string? K1pay { get; set; }
        public string? K1payda { get; set; }
        public string? K1edinmeSebebi { get; set; }
        public string? K1yevmiyeNo { get; set; }
        public string? K1yevmiyeTarih { get; set; }
        public string? K2pay { get; set; }
        public string? K2payda { get; set; }
        public string? K3pay { get; set; }
        public string? K3payda { get; set; }
        public string? K4pay { get; set; }
        public string? K4payda { get; set; }
