...
{
    public partial class NviYapiTest
    {
        ...
        public string? EskiGeometry { get; set; }
        public string? YapidurumAdi { get; set; }
        public string? YapitipAdi { get; set; }
