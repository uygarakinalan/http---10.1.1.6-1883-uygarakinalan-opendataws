...
{
    public partial class ViewGaskiKuyuKaynak
    {
        ...
        public string? StatikSeviye { get; set; }
        public string? DinamikSeviye { get; set; }
        public double? Kot { get; set; }
        public string? AnalizSonuclari { get; set; }
