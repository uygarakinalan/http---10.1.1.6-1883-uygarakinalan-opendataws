...
{
    public partial class TakbisTuzelkisizemin02092022YdkEx
    {
        public int TakbisId { get; set; }
        public int? KisiId { get; set; }
        public string? KisiUnvani { get; set; }
        public int? KisiTipi { get; set; }
        ...
        public string? Tapuaciklama { get; set; }
        public string? EskiGeo { get; set; }
        ...
        public decimal? GaskiAlani { get; set; }
        public double? GaskiHisseOran { get; set; }
    }
}
